...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "event_data_website_id_created_at_event_key_idx" ON "event_data"("website_id", "created_at", "event_key");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "session_website_id_created_at_idx" ON "session"("website_id", "created_at");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "session_website_id_created_at_hostname_idx" ON "session"("website_id", "created_at", "hostname");
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "session_website_id_created_at_subdivision1_idx" ON "session"("website_id", "created_at", "subdivision1");
